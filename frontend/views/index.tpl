...
<head>
    ...
    <title>Programming Languages - Lab3</title>
...
<body>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                <div class="col-lg-5 col-sm-6">
	                    ...
	                    <h2 class="section-heading">Keywords Table</h2>
	                    <p class="lead"></p>
	                </div>
   ...
   % end
	...
	<div class="footer">
			            ...
			            % for ii in range(1,num_of_pages+1):
							% if current_page == ii:
							<span class="page active">{{ii}}</span>
							%else:
							<span>
							<a href="/pagenums/{{ii}}/query/{{words}}" class="page">{{ii}}</a>
							</span>
							% end
						%end
						</div> 
